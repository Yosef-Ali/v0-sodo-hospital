...
export function ImportActionsCard({ importId, onEdit }: ImportActionsCardProps) {
  ...
  const handleDelete = async () => {
    ...
    if (result.success) {
      toast({
        ...
        description: "The import permit has been permanently removed.",
      })
      router.push("/import")
      router.refresh()
    } else {
      toast({
        title: "Delete Failed",
        description: result.error || "Could not delete import.",
        variant: "destructive",
      })
      setOpen(false) 
    }
          ...
          <AlertDialogContent className="bg-gray-800 border-gray-700 text-gray-200">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-gray-400">
                This action cannot be undone. This will permanently remove this import permit and all associated documents.
              </AlertDialogDescription>
            </AlertDialogHeader>
